const word_games_activities = [
    {
        category: "word_games",
        name: "Anagram",
        link: "Anagram Game/anagram.html",
        time: "2min+",
    ...
    },
    {
        category: "word_games",
        name: "Word Rush",
        link: "Word Rush Game/wordrush.html",
        time: "2min+",
        tags: ["group","individual"],
...
const math_games_activities = [
    {
        ...
        name: "Greedy Pig",
        link: "Greedy Pig Game/greedypig.html",
        time: "5min+",
    ...
    },
    {
        category: "maths_games",
        name: "Closest Number",
        link: "Closest Number Game/closestnumber.html",
        time: "2min+",
        tags: ["individual"],
...
const team_building_activities = [
    {
        ...
        link: "Never Have I Ever Games/neverhaveiever.html",
        time: "5min+",
        tags: ["group"],
    ...
    for (let x in activity_lists){
        ...
        for (let i=0; i<category_list.length;i++){
            ...
            for (x in activity.tags){
                tag = activity.tags[x];
                if (tag == "device"){
                    activity_html += "<span class=\"badge rounded-pill bg-device\" data-bs-toggle=\"tooltip\" data-bs-placement=\"right\" title=\"Devices Required\"><img src=\"/Anagram Game/res/laptop.svg\" alt=\"Devices\"></span>\n"
                } else if (tag == "activity") {
                    activity_html += "<span class=\"badge rounded-pill bg-activity\" data-bs-toggle=\"tooltip\" data-bs-placement=\"right\" title=\"Movement Required\"><img src=\"/Anagram Game/res/activity.svg\" alt=\"Movement\"></span>\n"
                } else if (tag == "group") {
                    activity_html += "<span class=\"badge rounded-pill bg-group\" data-bs-toggle=\"tooltip\" data-bs-placement=\"right\" title=\"Groups\"><img src=\"/Anagram Game/res/people.svg\" alt=\"Group\"></span>\n"
                } else if (tag == "individual") {
                    activity_html += "<span class=\"badge rounded-pill bg-individual\" data-bs-toggle=\"tooltip\" data-bs-placement=\"right\" title=\"Individual\"><img src=\"/Anagram Game/res/person.svg\" alt=\"Individual\"></span>\n"
                }
            }
